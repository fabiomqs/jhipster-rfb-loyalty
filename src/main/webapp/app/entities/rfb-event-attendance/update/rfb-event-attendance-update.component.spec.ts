  ...
  describe('RfbEventAttendance Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call RfbEvent query and add missing value', () => {
        ...
        const rfbEvent: IRfbEvent = { id: 25050 };
        rfbEventAttendance.rfbEvent = rfbEvent;

        const rfbEventCollection: IRfbEvent[] = [{ id: 93278 }];
        jest.spyOn(rfbEventService, 'query').mockReturnValue(of(new HttpResponse({ body: rfbEventCollection })));
        const additionalRfbEvents = [rfbEvent];
        const expectedCollection: IRfbEvent[] = [...additionalRfbEvents, ...rfbEventCollection];
        jest.spyOn(rfbEventService, 'addRfbEventToCollectionIfMissing').mockReturnValue(expectedCollection);
      ...
      it('Should call RfbUser query and add missing value', () => {
        const rfbEventAttendance: IRfbEventAttendance = { id: 456 };
        const rfbUser: IRfbUser = { id: 69712 };
        rfbEventAttendance.rfbUser = rfbUser;

        const rfbUserCollection: IRfbUser[] = [{ id: 6758 }];
      ...
      it('Should update editForm', () => {
        const rfbEventAttendance: IRfbEventAttendance = { id: 456 };
        const rfbEvent: IRfbEvent = { id: 8374 };
        rfbEventAttendance.rfbEvent = rfbEvent;
        const rfbUser: IRfbUser = { id: 90310 };
        rfbEventAttendance.rfbUser = rfbUser;
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<RfbEventAttendance>>();
        const rfbEventAttendance = { id: 123 };
        jest.spyOn(rfbEventAttendanceService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(rfbEventAttendanceService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ rfbEventAttendance });
        comp.ngOnInit();
