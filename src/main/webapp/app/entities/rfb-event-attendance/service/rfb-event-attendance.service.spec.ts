    ...
    describe('Service methods', () => {
      ...
      describe('addRfbEventAttendanceToCollectionIfMissing', () => {
        ...
        it('should add only unique RfbEventAttendance to an array', () => {
          const rfbEventAttendanceArray: IRfbEventAttendance[] = [{ id: 123 }, { id: 456 }, { id: 97143 }];
        ...
        it('should return initial array if no RfbEventAttendance is added', () => {
          const rfbEventAttendanceCollection: IRfbEventAttendance[] = [{ id: 123 }];
          expectedResult = service.addRfbEventAttendanceToCollectionIfMissing(rfbEventAttendanceCollection, undefined, null);
          expect(expectedResult).toEqual(rfbEventAttendanceCollection);
        });
      });
    });
