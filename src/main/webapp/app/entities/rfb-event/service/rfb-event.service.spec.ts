    ...
    describe('Service methods', () => {
      ...
      describe('addRfbEventToCollectionIfMissing', () => {
        ...
        it('should add only unique RfbEvent to an array', () => {
          const rfbEventArray: IRfbEvent[] = [{ id: 123 }, { id: 456 }, { id: 95615 }];
        ...
        it('should return initial array if no RfbEvent is added', () => {
          const rfbEventCollection: IRfbEvent[] = [{ id: 123 }];
          expectedResult = service.addRfbEventToCollectionIfMissing(rfbEventCollection, undefined, null);
          expect(expectedResult).toEqual(rfbEventCollection);
        });
      });
    });
