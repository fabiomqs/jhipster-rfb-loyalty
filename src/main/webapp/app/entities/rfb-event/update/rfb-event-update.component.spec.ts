  ...
  describe('RfbEvent Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call RfbLocation query and add missing value', () => {
        ...
        const rfbLocation: IRfbLocation = { id: 42038 };
        rfbEvent.rfbLocation = rfbLocation;

        const rfbLocationCollection: IRfbLocation[] = [{ id: 20800 }];
        jest.spyOn(rfbLocationService, 'query').mockReturnValue(of(new HttpResponse({ body: rfbLocationCollection })));
        ...
        jest.spyOn(rfbLocationService, 'addRfbLocationToCollectionIfMissing').mockReturnValue(expectedCollection);
      ...
      it('Should update editForm', () => {
        const rfbEvent: IRfbEvent = { id: 456 };
        const rfbLocation: IRfbLocation = { id: 53832 };
        rfbEvent.rfbLocation = rfbLocation;
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<RfbEvent>>();
        const rfbEvent = { id: 123 };
        jest.spyOn(rfbEventService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(rfbEventService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ rfbEvent });
        comp.ngOnInit();
