  ...
  describe('RfbUser Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call homeLocation query and add missing value', () => {
        ...
        const homeLocation: IRfbLocation = { id: 76206 };
        rfbUser.homeLocation = homeLocation;

        const homeLocationCollection: IRfbLocation[] = [{ id: 48919 }];
        jest.spyOn(rfbLocationService, 'query').mockReturnValue(of(new HttpResponse({ body: homeLocationCollection })));
      ...
      it('Should update editForm', () => {
        const rfbUser: IRfbUser = { id: 456 };
        const homeLocation: IRfbLocation = { id: 59212 };
        rfbUser.homeLocation = homeLocation;
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<RfbUser>>();
