    ...
    describe('Service methods', () => {
      ...
      describe('addRfbLocationToCollectionIfMissing', () => {
        ...
        it('should add only unique RfbLocation to an array', () => {
          const rfbLocationArray: IRfbLocation[] = [{ id: 123 }, { id: 456 }, { id: 91042 }];
        ...
        it('should return initial array if no RfbLocation is added', () => {
          const rfbLocationCollection: IRfbLocation[] = [{ id: 123 }];
          expectedResult = service.addRfbLocationToCollectionIfMissing(rfbLocationCollection, undefined, null);
          expect(expectedResult).toEqual(rfbLocationCollection);
        });
      });
    });
